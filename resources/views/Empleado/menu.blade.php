...
<html>
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="../resources/css/menuemple.css">
  ...
  <body class="p-3 m-0 border-0 bd-example">
    <nav class="navbar navbar-expand-lg navbar navbar-dark bg-dark">
      <div class="container-fluid">
        <a class="navbar-brand" href="http://localhost/visius/public/visius_empleados"><img src="../imgs/iconempleados.ico" class="logo"></a>
        <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
          ...
          <ul class="navbar-nav me-auto mb-2 mb-lg-0" style="font-family: century gothic;">
            <li class="nav-item">
              <a class="nav-link active coloropcion" aria-current="page" href="http://localhost/visius/public/visius_mis_tareas" ><i class="bi bi-card-checklist"></i> Mis Tareas</a>
            </li>
          </ul>
          <div class="d-flex" role="search">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0" style="font-family: century gothic;">
            <li class="nav-item">
              <a class="nav-link active coloropcion" aria-current="page" href="http://localhost/visius/public/visius_mi_info_empleado"><i class="bi bi-person-circle"></i> Mi Info</a>
            </li>
            <li class="nav-item" >
                    ...
                    <div class="row gx-5 justify-content-center">
                        <div class="col-xxl-8">
                            <div class="text-center my-5">
                                ...
                                <p class="lead fw-light mb-4">Recuerda siempre revisar las tareas asignadas por tu supervisor.</p>
                                <p class="text-muted">Una vez terminada dicha tarea, es necesario comunicarselo a tu supervisor. Si tienes alguna duda, contacta directamente con dicha persona.</p>
