    ...
    {{-- <table class="container table table-hover table-bordered mt-2"> --}}
        {{-- Encabezados --}}
                    ...
                    <tr>
                        ...
                        <a class="btn btn-primary btn-sm" href="/products/edit/{{$item->id_area}}">Modificar</a>
                        {{-- boton para eliminar --}}
                        <button class="btn btn-danger btn-sm" url="/products/destroy/{{$item->id_area}}" onclick="destroy(tdis)" token="{{csrf_token()}}">Eliminar</button>
                        </td>
                    </tr>
                    @endforeach
                    </table>
